...
function main() {
  ...
  assert.ok(chatComposerToolsJs.includes('renderChatSuggestionStrip'), 'chat composer utilities should consolidate chat prompt suggestions into one adaptive strip');
